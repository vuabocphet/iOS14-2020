...
public class CustomSeekBarIOS extends View {
    ...
    public CustomSeekBarIOS(Context context) {
        super(context);
        this.init(context, null);
    }

    public CustomSeekBarIOS(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnValuesChangeListener {
         ...
         */
        void onPointsChanged(CustomSeekBarIOS boxedPoints, int points);
        void onStartTrackingTouch(CustomSeekBarIOS boxedPoints);
        void onStopTrackingTouch(CustomSeekBarIOS boxedPoints);
    }
